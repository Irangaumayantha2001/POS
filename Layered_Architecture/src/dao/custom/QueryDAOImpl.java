...
public class QueryDAOImpl implements QueryDAO {
    ...
    public ArrayList<CustomerDTO> searchOrderByOrderID(String id) throws SQLException, ClassNotFoundException {
        ...
        ArrayList<CustomerDTO> orderRecords = new ArrayList();
        while (rst.next()) {
            orderRecords.add(new CustomerDTO(rst.getString(1), LocalDate.parse(rst.getString(2)), rst.getString(3), rst.getString(4), rst.getInt(5), rst.getBigDecimal(6)));
        }
        return orderRecords;
    }
}
